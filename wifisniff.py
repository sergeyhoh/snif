...
def post_request(router_id, device_id, time):
    parse_url = "https://api.parse.com/1/classes/track"
    payload = {
        "router_id": router_id,
        "device_id": device_id,
        "timestamp":
    ...
    headers = {
        ...
        'X-Parse-Application-Id': 'DbJzT8albHjlHC921InE4EiBTKcqBLaig98BFrG4',
        'X-Parse-REST-API-Key': 'Be8u11V7u66c6lVDJvwA8tMo5XWY4iNGhx0JK6Bn'
    }
