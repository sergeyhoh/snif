    ...
    def enable_mon_mode(self):
        ...
        if match:
            try:
                ...
                os.system("uci del wireless.@wifi-iface[%s].key1" % iface_num)
                os.system("uci del wireless.@wifi-iface[%s].key2" % iface_num)
                os.system("uci del wireless.@wifi-iface[%s].key3" % iface_num)
                os.system("uci del wireless.@wifi-iface[%s].key4" % iface_num)
